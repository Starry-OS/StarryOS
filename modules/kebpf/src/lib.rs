...
use starry_kernel::{bpf::tansform::EbpfKernelAuxiliary, mm::VmBytes, syscall::SyscallHandler};
use syscalls::Sysno;
...
pub fn kebpf_init() -> i32 {
    ...
    let res = starry_kernel::syscall::register_syscall_handler(Sysno::bpf, &Handler);
    if let Err(e) = res {
