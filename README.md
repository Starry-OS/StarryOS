...
NOTICE:
After April 2026, the componentized macrokernel StarryOS has been upgraded into the tgoskits kernel component library. [The latest StarryOS](https://github.com/rcore-os/tgoskits/tree/dev/os/StarryOS) is currently under continuous development and supports [more applications and hardware](https://github.com/rcore-os/tgoskits/tree/dev/apps/starry).
